...
nba_teams_df.rename(columns={'id': 'TEAM_ID', 'full_name': 'TEAM_NAME', 'abbreviation': 'TEAM_ABR', 'nickname': 'TEAM_NICKNAME', 'city': 'TEAM_CITY', 'state': 'TEAM_STATE', 'year_founded': 'TEAM_YEAR_FOUNDED'}, inplace=True)
...
sqlalchemy_interact.insert_df_to_mysql_sqlalchemy(nba_teams_df, "teams")
