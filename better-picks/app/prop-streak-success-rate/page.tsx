...
const sampleData: Record<string, { player: string; team: string; streak: number; successRate: number; odds: number }[]> = {
  NBA: [
    { player: "LeBron James", team: "Lakers", streak: 5, successRate: 72, odds: -950 },
    { player: "Stephen Curry", team: "Warriors", streak: 7, successRate: 85, odds: -900 },
    { player: "Giannis Antetokounmpo", team: "Bucks", streak: 6, successRate: 79, odds: -870 },
  ],
  NFL: [
    { player: "Patrick Mahomes", team: "Chiefs", streak: 4, successRate: 68, odds: -850 },
    { player: "Justin Jefferson", team: "Vikings", streak: 6, successRate: 81, odds: -820 },
  ],
  MLB: [
    { player: "Aaron Judge", team: "Yankees", streak: 8, successRate: 89, odds: -950 },
    { player: "Shohei Ohtani", team: "Angels", streak: 5, successRate: 74, odds: -900 },
  ],
  NHL: [
    { player: "Connor McDavid", team: "Oilers", streak: 7, successRate: 83, odds: -800 },
    { player: "Nathan MacKinnon", team: "Avalanche", streak: 5, successRate: 77, odds: -750 },
  ],
};
        ...
        <table className="w-full border-collapse border border-gray-700 text-lg">
          <thead className="bg-gray-700">
            <tr>
              ...
              <th className="border border-gray-600 px-4 py-3 text-left">Team</th>
          ...
          <tbody>
            {sampleData[selectedLeague]?.map((player, index) => (
              <tr key={index} className="border border-gray-600">
                ...
                <td className="border border-gray-700 px-4 py-3">{player.team}</td>
