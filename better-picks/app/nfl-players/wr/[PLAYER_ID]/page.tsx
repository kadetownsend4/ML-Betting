/*
 * This React component fetches and displays weekly receiving end stats based on the player ID from the URL. It retrieves player statistics 
 * through an API request, handles loading and error states, and presents the data in a table format. If no stats are found, a message is 
 * displayed. The component also includes sticky breadcrumb navigation for easy navigation.
 *
